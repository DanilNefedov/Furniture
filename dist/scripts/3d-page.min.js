...
function init(){let wrapper=document.querySelector('.model__container');const scene=new THREE.Scene()
scene.background=new THREE.Color("#656565");const camera=new THREE.PerspectiveCamera(70,window.innerWidth/window.innerHeight,0.1,1000);switch(idProduct){case'0':camera.position.set(6,3,6)
break;case'1':if(window.innerWidth<=380){camera.position.set(3.5,3,4)}else{camera.position.set(2.5,2.5,3)}
window.addEventListener('resize',function(){if(innerWidth<=380){camera.position.set(3.5,3,4)}else{camera.position.set(2.5,2.5,3)}});break;case'2':if(window.innerWidth<=550){camera.position.set(-55,100,70)}else{camera.position.set(50,50,50)}
window.addEventListener('resize',function(){if(window.innerWidth<=550){camera.position.set(-55,100,70)}else{camera.position.set(50,50,50)}});break;case'4':case'5':camera.position.set(2,2,2)
break;case'6':case'3':camera.position.set(1,1,1)
break;case'7':camera.position.set(1,1,3)
break;case'8':camera.position.set(400,400,400)
break;}
