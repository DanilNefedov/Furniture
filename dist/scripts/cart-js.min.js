...
let counterBuildElem=0;let storageELem;window.addEventListener('storage',function(){storageELem=JSON.parse(localStorage.getItem('objElem'))
buildElem(storageELem)})
function buildElem(elem){for(let i=counterBuildElem;i<elem.length;i++){counterBuildElem++
